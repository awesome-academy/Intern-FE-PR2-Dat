                ...
                <Grid container spacing={2}>
                        ...
                        <Item elevation='0'>
                            ...
                            <List>
                                <ListItem disablePadding>
                                    <FooterList primary='New Products' />
                                </ListItem>
                                <ListItem disablePadding>
                                    <FooterList primary='Top Sellers' />
                                </ListItem>
                                <ListItem disablePadding>
                                    <FooterList primary='Our Blog' />
                                </ListItem>
                                <ListItem disablePadding>
                                    <FooterList primary='About Our Shop' />
                                </ListItem>
                            </List>
                        </Item>
                    </Grid>
                    <Grid item xs={2}>
                        <Item elevation='0'>
                            ...
                            <List>
                                <ListItem disablePadding>
                                    <FooterList primary='Our Team' />
                                </ListItem>
                                <ListItem disablePadding>
                                    <FooterList primary='Our Blog' />
                                </ListItem>
                                <ListItem disablePadding>
                                    <FooterList primary='About Us' />
                                </ListItem>
                                <ListItem disablePadding>
                                    <FooterList primary='Secure Shopping' />
                                </ListItem>
                            </List>
                        </Item>
                    </Grid>
